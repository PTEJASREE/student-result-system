...
String q3="select RegNo,s1,s2,s3,s4,s5,l1,l2,l3 from grader20 where sem='3' and RegNo in (select RegNo from studentdetails where Regulation='r20')";
String q4="select RegNo,s1,s2,s3,s4,s5,l1,l2,l3 from grader20 where sem='4' and RegNo in (select RegNo from studentdetails where Regulation='r20')";
...
%>
<form class="" action="viewtables3.jsp" method="post">

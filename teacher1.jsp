...
<%
  ...
  String q1="select RegNo,s1,s2,s3,s4,s5,l1,l2,l3 from grader20 where sem='1' and RegNo in (select RegNo from studentdetails where Regulation='r20')";
  String q2="select RegNo,s1,s2,s3,s4,s5,l1,l2,l3 from grader20 where sem='2' and RegNo in (select RegNo from studentdetails where Regulation='r20')";
  String q3="select RegNo,s1,s2,s3,s4,s5,l1,l2,l3 from grader19 where sem='3' and RegNo in (select RegNo from studentdetails where Regulation='r20')";
  String q4="select RegNo,s1,s2,s3,s4,s5,l1,l2,l3 from grader19 where sem='4' and RegNo in (select RegNo from studentdetails where Regulation='r20')";
  String q5="select RegNo,s1,s2,s3,s4,s5,l1,l2,l3 from grader20 where sem='5' and RegNo in (select RegNo from studentdetails where Regulation='r20')";
  String q6="select RegNo,s1,s2,s3,s4,s5,l1,l2,l3 from grader20 where sem='6' and RegNo in (select RegNo from studentdetails where Regulation='r20')";
  String q7="select RegNo,s1,s2,s3,s4,s5,l1,l2,l3 from grader20 where sem='7' and RegNo in (select RegNo from studentdetails where Regulation='r20')";
  String q8="select RegNo,s1,s2,s3,s4,s5,l1,l2,l3 from grader20 where sem='8' and RegNo in (select RegNo from studentdetails where Regulation='r20')";
  ...
  %>
  <form class="" action="teacher1.jsp" method="post">
  ...
  <h2 id="sem201">2020 Students 1st Semester Grades</h2>
  <table>
  <tr>
  ...
  %>
  <h2 id="sem202">2020 Students 2nd Semester Grades</h2>
  <table>
  <tr>
  <th>Registration Number</th>
  <th>DLD</th>
  ...
  %>
  <h2 id="sem193">2020 Students 3rd Semester Grades</h2>
  <table>
  <tr>
  <th>Registration Number</th>
  <th>Mathematics-4</th>
  ...
  %>
  <h2 id="sem193">2020 Students 4th Semester Grades</h2>
  <table>
  <tr>
  <th>Registration Number</th>
...
%>
  ...
  %>
  <h2>2020 Students 5th Semester Grades</h2>
  <table>
  <tr>
  <th>Registration Number</th>
  ...
  %>
  <h2>2020 Students 6th Semester Grades</h2>
  <table>
  <tr>
  <th>Registration Number</th>
  <th>Data Mining</th>
  ...
  %>
  <h2>2020 Students 7th Semester Grades</h2>
  <table>
  <tr>
  <th>Registration Number</th>
  ...
  %>
  <h2>2020 Students 8th Semester Grades</h2>
  <table>
  <tr>
  <th>Registration Number</th>
  <th>UML</th>
